...
export const lightCode: ColorType = '#87837826';
export const lightCodeLight: ColorType = '#eb5757';
...
export const darkCode: ColorType = '#a1d21b';
export const darkCodeLight: ColorType = '#262a2d';
